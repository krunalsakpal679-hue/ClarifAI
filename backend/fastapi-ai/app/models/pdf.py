"""
ClarifAI PDF Extraction Pydantic Schemas
"""
...
class PageExtractionItem(BaseModel):
    ...
    text: str = Field(..., description="Extracted digital text for this page")
    character_count: int = Field(..., description="Total non-whitespace character count")
    ocr_required: bool = Field(..., description="True if character count is below OCR threshold")
...
class PDFExtractionResponse(BaseModel):
    ...
    full_text: str = Field(..., description="Concatenated full document text")
