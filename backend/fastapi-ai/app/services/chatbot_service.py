...
output validation, and multilingual (Hindi/English) support per PRD v2.3 Chapters 17.3, 17.10, 19, 28.5, 34, 50, and 56.
...
# Standard Controlled No-Answer Response when evidence gates fail (English)
...
# Standard Controlled No-Answer Response when evidence gates fail (Hindi)
HINDI_CONTROLLED_NO_ANSWER_RESPONSE: str = (
    "मैं इस प्रश्न का उत्तर देने में असमर्थ हूँ क्योंकि प्रदान किए गए दस्तावेज़ में पर्याप्त प्रासंगिक खंड शामिल नहीं हैं।"
)
...
def construct_chatbot_system_prompt(evidence_items: List[Dict[str, Any]], target_language: str = "en") -> str:
    """
    ...
    Supports Hindi target language when specified.
    """
    evidence_lines = []
    ...
    if target_language.lower() in ["hi", "hindi"]:
        lang_instruction = "6. IMPORTANT: Respond in clear, natural Devanagari Hindi (हिंदी) while adhering to all evidence rules.\n"
