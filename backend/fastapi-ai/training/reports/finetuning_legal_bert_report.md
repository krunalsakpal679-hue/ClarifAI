# ClarifAI Legal-BERT Fine-Tuning & Evaluation Report (Phase 3)

**Evaluation Date:** September 25, 2026  
**Status:** COMPLETE  
**Selection Verdict:** SELECTED (Fine-tuned model demonstrates superior Macro-F1 and calibrated severity separation)  
**Checkpoint Path:** `C:\ClarifAI- AIPipeline\backend\fastapi-ai\training\checkpoints\legalbert\v1.0`  
...
**Decision:** **SELECTED (Fine-tuned model demonstrates superior Macro-F1 and calibrated severity separation)**  
**Justification:**
1. Macro-F1 increased significantly from **0.1000** (baseline) to **0.4792** (fine-tuned).
